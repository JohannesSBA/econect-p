...
const heroHighlights = [
  ...
  { value: "24/7", label: "Support available when you need it" },
] as const;
...
const coreFeatures: CoreFeature[] = [
  ...
  },
  {
    ...
    description:
      "Step-by-step guidance supports first-time internet users with simple instructions, visuals, and streamlined flows.",
    tag: "Guided",
  ...
  },
  {
    ...
    description:
      "Access tips, templates, and interview prep tailored to Ethiopia's job market, all in one dashboard.",
    tag: "Resources",
...
const pricingTiers: PricingTier[] = [
  {
    ...
    features: [
      ...
      "Guided onboarding with local context",
...
const contactOptions: ContactOption[] = [
  ...
  },
  {
    title: "Email support",
    description:
      "Questions about payments, onboarding, or hiring tools? We respond within 24 hours.",
...
export default function LandingPage() {
  ...
  const heroDescription =
    "Econnect brings job seekers, employers, and professionals onto one trusted platform with guided experiences designed for every level of familiarity with digital tools.";
  const visionStatement =
    "We believe access to opportunity should not depend on geography or comfort with global tools. Econnect delivers a mobile-first, affordable gateway into Ethiopia's labor market.";
  const heroBadgeText = "🚀 Ethiopia's most innovative job platform";
  const footerDescription =
    "Connecting talent with opportunity across Ethiopia. Your career journey starts here.";
  const footerNote = "© 2024 Econnect. All rights reserved.";
    ...
    <div className="bg-stone-50 text-slate-900">
      ...
      <main>
        ...
        >
          ...
          <div className="container mx-auto px-4 pb-24 pt-12 lg:pt-16">
                ...
                <form className="mt-6 space-y-4">
                  ...
                  <label className="text-sm font-medium text-slate-700">
                    ...
                    <textarea
                      name="message"
                      rows={4}
                      placeholder="Tell us about the roles you need, skills required, or integrations you're exploring."
