...
const loginCopy = {
  welcomeTitle: "Welcome to Econnect",
  welcomeSubtitle: "Sign in to continue your career journey",
        ...
        <div className="w-full max-w-lg">
          <Card className="border-0 bg-white/90 shadow-xl backdrop-blur">
            <CardHeader className="space-y-2 pb-4 text-center">
              ...
              <p className="text-sm text-slate-600">{loginCopy.enterCredentials}</p>
            </CardHeader>
            <CardContent className="space-y-7">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    {loginMethod === "email" ? loginCopy.email : loginCopy.phone}
                  </Label>
                  <div className="relative">
                    {loginMethod === "email" ? (
                    ...
                    <Input
                      ...
                      placeholder={
                        loginMethod === "email"
                          ? loginCopy.emailPlaceholder
                          : loginCopy.phonePlaceholder
                      }
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-slate-500">
              {loginCopy.termsAgreement}{" "}
              <Link
                href="/terms"
                className="font-medium text-blue-600 transition hover:text-blue-700"
              >
                {loginCopy.termsOfService}
              </Link>{" "}
              {loginCopy.and}{" "}
              <Link
                href="/privacy"
