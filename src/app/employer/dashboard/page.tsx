    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
          <Link className="relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 p-6 shadow-lg transition-transform hover:scale-[1.02] hover:shadow-xl group" href="/employer/jobs/active">
          ...
          <Link className="relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 p-6 shadow-lg transition-transform hover:scale-[1.02] hover:shadow-xl group" href="/employer/jobs/archived">
            <div className="flex items-center">
          ...
          <Link className="relative overflow-hidden rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 p-6 shadow-lg transition-transform hover:scale-[1.02] hover:shadow-xl group" href="/employer/jobs/new">
            <div className="flex items-center">
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/employer/jobs/active" className="text-sm text-blue-600 hover:underline">View all</Link>
          </div>
            ...
            {jobs.slice(0,6).map(job => (
              <div key={job.id} className="p-4 flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <Link href={`/employer/jobs/${job.id}/applicants`} className="text-blue-600 text-sm hover:underline">Applicants</Link>
                </div>
              </div>
            ))}
            {jobs.length === 0 && (
              <div className="p-6 text-sm text-gray-600">No jobs yet — <Link className="text-blue-600 hover:underline" href="/employer/jobs/new">create your first listing</Link>.</div>
            )}
          </div>
        </div>
      </div>
