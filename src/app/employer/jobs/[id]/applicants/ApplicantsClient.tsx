...
export default function ApplicantsClient({ jobId, initialApplications }: { jobId: string; initialApplications: Application[] }) {
        ...
        {filtered.map(app => (
          <div key={app.id} className="p-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Link href={`/user/${app.user?.id}`} className="text-sm text-blue-600 hover:underline">View profile</Link>
              {app.resumeUrl ? (
