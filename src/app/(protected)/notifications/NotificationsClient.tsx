...
const getDestinationUrl = (
  ...
  if (
    ...
    return `/jobs/${payload.jobId}`;
  }
  if (payload?.postId) {
    return `/dashboard?post=${payload.postId}`;
  }
  return "/dashboard";
};
...
export default function NotificationsClient({ initial }: NotificationsClientProps) {
  ...
  const openNotification = (notification: SerializableNotification) => {
    window.location.href = getDestinationUrl(notification);
  };
