...
export default async function ProfilePage() {
  ...
  return <ProfilePageClient userWithProfile={userWithProfile} posts={posts as any} peopleAlsoViewed={peopleAlsoViewed as any} similarProfiles={similarProfiles as any} connectionCount={connectionCount} savedPosts={savedPosts as any} savedJobs={savedJobs as any} />
}
