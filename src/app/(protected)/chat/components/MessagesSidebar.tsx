...
export default function MessagesSidebar({ contacts, userId }: Props) {
  ...
  return (
    <div className="flex flex-col h-full border-r bg-white">
      ...
      <div className="flex-1 overflow-y-auto">
        {filtered.map(c => {
          const href = `/chat/${chatHrefConstructor(c.id, userId)}`
      ...
      <div className="p-4 border-t">
        <Link href="/pending-requests" className="flex items-center space-x-2 w-full hover:bg-gray-50 p-3 rounded">
