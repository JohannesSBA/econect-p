...
export default async function CompanyPage({
  ...
  if (
    !company ||
    (company.role !== "EMPLOYER" && company.role !== "RECRUITER")
  ) {
    notFound();
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <CardContent className="p-6">
                <div className="flex items-start space-x-6">
                  <Avatar className="h-20 w-20">
                    <AvatarImage
                      src={getCompanyLogoUrl(company.image, company.name)}
                    />
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-purple-600">
                      {company.jobListings.length > 0
                        ? Math.round(
                            totalApplications / company.jobListings.length,
                          )
                        : 0}
                    </div>
                    <div className="text-sm text-gray-600">
            ...
            <Card className="bg-white shadow-sm">
              <CardHeader>
                <CardTitle>
                  Open Positions ({company.jobListings.length})
                </CardTitle>
              </CardHeader>
              <CardContent>
                {company.jobListings.length > 0 ? (
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-white shadow-sm">
              ...
              <CardContent className="space-y-3">
                ...
                />
                <Link
                  href={`/${lang}/chat/${chatHrefConstructor(user.id, id)}`}
                >
            ...
            <Card className="bg-white shadow-sm">
              ...
              <CardContent>
                <p className="text-sm text-gray-600">
                  Companies in similar industries and locations will appear
                  here.
                </p>
              </CardContent>
            </Card>
