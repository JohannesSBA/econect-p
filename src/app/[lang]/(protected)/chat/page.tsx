...
export default async function ChatPage({ params }: { params: Promise<{ lang: 'en' | 'am' }> }) {
          ...
          <Card className="bg-white shadow-sm mb-6">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-2xl font-semibold text-gray-900">Messages</CardTitle>
                  <p className="text-gray-600 mt-1">Connect with your network</p>
                </div>
              </div>
            </CardHeader>
          </Card>
              ...
              {conversations.length > 0 ? (
                <div className="space-y-1">
                  {conversations.map((conversation) => (
                    <Link key={conversation.id} href={`/${lang}/chat/${conversation.chatId}`}>
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">Start connecting with people to begin messaging</p>
                  <Link href={`/${lang}/grow-network`}>
          ...
          <Card className="bg-white shadow-sm mt-6">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Link href={`/${lang}/connects`}>
                  <Button variant="outline" className="w-full justify-start">
                    <MessageSquare className="h-4 w-4 mr-2" />
                    View Connections
                  </Button>
                </Link>
                <Link href={`/${lang}/pending-requests`}>
                  <Button variant="outline" className="w-full justify-start">
                    <MessageSquare className="h-4 w-4 mr-2" />
                    Pending Requests
                  </Button>
