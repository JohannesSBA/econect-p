...
const CardNav: React.FC<CardNavProps> = ({
  ...
  const calculateHeight = () => {
    ...
    const minHeight = isMobile ? 140 : 220;
    return Math.max(topBar + contentHeight + padding, minHeight);
  };
            ...
            >
              ...
              <div className="nav-card-links mt-auto flex flex-col gap-[2px]">
                {item.links?.map((lnk, i) => (
                  ...
                  >
                    <ArrowRight className="nav-card-link-icon shrink-0" aria-hidden="true" />
                    {lnk.label}
                  </a>
                ))}
              </div>
