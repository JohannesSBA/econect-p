  ...
  const items = [
    {
      ...
      textColor: "#fff",
      links: [
        { label: "Chats", ariaLabel: "Go to Messages", href: `/${lang}/chat` },
        { label: "New Messages", ariaLabel: "Go to New Messages", href: `/${lang}/connects` }
      ]
    },
    {
      label: "Listings", 
      ...
      textColor: "#fff",
      links: [
        { label: "Jobs", ariaLabel: "Go to Jobs", href: `/${lang}/jobs` },
        { label: "Applied Jobs", ariaLabel: "Go to Applied Jobs", href: `/${lang}/applied-jobs` }
      ]
    },
    {
      label: "People",
      ...
      textColor: "#fff",
      links: [
        { label: "Users", ariaLabel: "Go to Users", href: `/${lang}/users` },
        { label: "Connections", ariaLabel: "Go to Connections", href: `/${lang}/connects` },
        { label: "Employers", ariaLabel: "Go to Employers", href: `/${lang}/employers` }
      ]
    }
  ];
