...
export default async function JobApplicantsPage({ params }: { params: Promise<{ lang: 'en' | 'am' | 'om'; id: string }> }) {
  ...
  if (!job || job.employerId !== user.id) redirect(`/${lang}/employer/dashboard`)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="mt-6">
          <Link href={`/${lang}/employer/dashboard`} className="text-blue-600 hover:underline">Back to dashboard</Link>
        </div>
      </div>
    </div>
  )
