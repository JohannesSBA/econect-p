...
const DropdownPopover = (props: DropdownPopoverProps) => {
    return (
        <AriaPopover
            ...
            className={(state) =>
                cx(
                    "dropdown-force-light w-62 origin-(--trigger-anchor-point) overflow-auto rounded-lg bg-primary shadow-lg ring-1 ring-secondary_alt will-change-transform",
                    state.isEntering &&
...
const DropdownDotsButton = (props: AriaButtonProps & RefAttributes<HTMLButtonElement>) => {
    return (
        ...
        >
            <MoreVertical className="size-5 transition-inherit-all" />
        </AriaButton>
    );
};
